package streaming.retransmission;
...
public class RetransmissionBuffer {
    ...
    private static final int MAX_BUFFER_SIZE = 2000; // ✅ FIX: Increased from 500 to 2000 (~2.8MB) to keep packets longer for NACK retransmission
